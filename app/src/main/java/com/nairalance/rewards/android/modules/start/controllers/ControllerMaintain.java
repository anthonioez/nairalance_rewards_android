 ...
 */
public class ControllerMaintain extends ControllerActivity implements View.OnClickListener
{
    private static final String TAG = ControllerMaintain.class.getSimpleName();

    private TextView    textTitle;
    private Button buttonConfirm;
    private FrameLayout layoutMain;

    public ControllerMaintain(AppCompatActivity activity)
    {
        super(activity);
    }
    ...
    public void create(Bundle savedInstanceState)
    {
        ...
        activity.setContentView(R.layout.controller_maintain);

        layoutMain = activity.findViewById(R.id.layoutMain);
        UI.overrideFonts(activity, layoutMain, Rewards.appFont);

        textTitle = activity.findViewById(R.id.textTitle);
        textTitle.setTypeface(Rewards.appFontLight);

        buttonConfirm = activity.findViewById(R.id.buttonConfirm);
